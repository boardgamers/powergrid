...
export const map: GameMap = {
    ...
    cities: [
        ...
        { name: Cities.Qingdao, region: Regions.Green, x: 3322, y: 1316 },
        ...
        { name: Cities.Baotou, region: Regions.Red, x: 2500, y: 862 },
        ...
        { name: Cities.Yinchuan, region: Regions.Purple, x: 2208, y: 1058 },
        ...
        { name: Cities.Guiyang, region: Regions.Yellow, x: 2212, y: 2112 },
    ],
    connections: [
        ...
        { nodes: [Cities.Chongqing, Cities.Guiyang], cost: 9 },
        { nodes: [Cities.Guiyang, Cities.Kunming], cost: 12 },
        { nodes: [Cities.Guiyang, Cities.Nanning], cost: 12 },
        { nodes: [Cities.Guiyang, Cities.Guangzhou], cost: 18 },
        ...
        { nodes: [Cities.Changsha, Cities.Guiyang], cost: 15 },
        { nodes: [Cities.Guiyang, Cities.Chengou], cost: 13 },
        ...
        { nodes: [Cities.Lanzhou, Cities.Yinchuan], cost: 9 },
        { nodes: [Cities.Yinchuan, Cities.Xining], cost: 11 },
        ...
        { nodes: [Cities.Nanjing, Cities.Qingdao], cost: 12 },
        { nodes: [Cities.Qingdao, Cities.Jinan], cost: 6 },
        { nodes: [Cities.Jinan, Cities.Tianjin], cost: 6 },
        { nodes: [Cities.Xining, Cities.Lanzhou], cost: 6 },
        { nodes: [Cities.Yinchuan, Cities.Baotou], cost: 9 },
        { nodes: [Cities.Baotou, Cities.Taiyuan], cost: 9 },
        { nodes: [Cities.Taiyuan, Cities.Yinchuan], cost: 14 },
        { nodes: [Cities.Yinchuan, Cities.Hami], cost: 25 },
        ...
        { nodes: [Cities.Beijing, Cities.Baotou], cost: 14 },
        ...
        { nodes: [Cities.Changchun, Cities.Jilin], cost: 2 },
