...
export const map: GameMap = {
    ...
    cities: [
        ...
        { name: Cities.Tampere, region: Regions.Brown, x: 492, y: 544 },
        { name: Cities.Helsinki, region: Regions.Brown, x: 530, y: 602 },
        { name: Cities.Espoo, region: Regions.Brown, x: 457, y: 603 },
        { name: Cities.Pori, region: Regions.Brown, x: 400, y: 526 },
        { name: Cities.Turku, region: Regions.Brown, x: 409, y: 593 },
        { name: Cities.Uppsala, region: Regions.Yellow, x: 350, y: 585 },
        { name: Cities.Stockholm, region: Regions.Yellow, x: 380, y: 660 },
        { name: Cities.Vasteras, region: Regions.Yellow, x: 295, y: 576 },
        { name: Cities.Drebro, region: Regions.Yellow, x: 295, y: 628 },
        ...
        { name: Cities.Tallinn, region: Regions.Pink, x: 475, y: 656 },
        ...
        { name: Cities.Riga, region: Regions.Pink, x: 472, y: 734 },
        ...
        { name: Cities.Malmo, region: Regions.Purple, x: 287, y: 787 },
        { name: Cities.Goteborg, region: Regions.Purple, x: 231, y: 700 },
        { name: Cities.Aalborg, region: Regions.Orange, x: 177, y: 717 },
        { name: Cities.Aarhus, region: Regions.Orange, x: 195, y: 758 },
        { name: Cities.Kobenhavn, region: Regions.Orange, x: 228, y: 792 },
        { name: Cities.Nykobingfalster, region: Regions.Orange, x: 238, y: 842 },
        { name: Cities.Ringkobing, region: Regions.Orange, x: 120, y: 733 },
        { name: Cities.Esbjerg, region: Regions.Orange, x: 104, y: 787 },
        { name: Cities.Odense, region: Regions.Orange, x: 148, y: 824 },
    ...
    regionalPowerPlants: {
        ...
        [Regions.Pink]: [
            // Baltic States
            { number: 18, type: PowerPlantType.Oil, cost: 1, citiesPowered: 3 },
    ...
    connections: [
        ...
        { nodes: [Cities.Visby, Cities.Riga], cost: 20 },
        { nodes: [Cities.Riga, Cities.Tallinn], cost: 11 },
        { nodes: [Cities.Tallinn, Cities.Tartu], cost: 5 },
        { nodes: [Cities.Tartu, Cities.Daugavpils], cost: 9 },
        { nodes: [Cities.Riga, Cities.Tartu], cost: 7 },
        ...
        { nodes: [Cities.Klaipeda, Cities.Riga], cost: 8 },
        { nodes: [Cities.Riga, Cities.Kaunas], cost: 8 },
        { nodes: [Cities.Riga, Cities.Daugavpils], cost: 7 },
